...
function PlaceItemCard({ place }: any) {
  return (
    <div className="w-full overflow-hidden rounded-xl shadow-md transition-transform transform hover:scale-105 cursor-pointer">
      ...
      <div className="p-4">
        <h2 className="text-xl font-semibold line-clamp-2">{place.name}</h2>
