    ...
    <div className="h-screen w-screen md:w-[400px] bg-white shadow-lg p-5 z-20 overflow-auto">
      ...
      <div>
        ...
        <div className="relative h-48">
          <Image
            src={`${BASE_PHOTO_URL}&photo_reference=${place?.photos[0]?.photo_reference}&key=${process.env.NEXT_PUBLIC_GOOGLE_PLACE_KEY}`}
            alt="placeholder"
            width={400}
            height={160}
        ...
        <div className="mt-5 flex gap-5">
          <button
            ...
            className="flex items-center p-1 px-3 bg-red-500 rounded-full text-white hover:scale-105 transition-all"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <button className="flex items-center p-1 px-3 bg-red-500 rounded-full text-white hover:scale-105 transition-all">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
